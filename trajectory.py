...
l_0 = lambert(GM_sun, X1, X2, tof, string)
print(tof/(24*60*60), l_0[0], l_0[1], l_0[3])  # Vinf1, Vinf2, DV_totalを表示する
...
ax.legend()
plt.tight_layout()
plt.savefig("310115_310915_3d.png", dpi=300)
plt.show()
...
plt.grid()
plt.axis('equal')
plt.savefig("310510_320314_2d.png", dpi=300)
plt.show()