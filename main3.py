...
with open("ephemeris_earth_2028-35.txt", "r") as file:
...
with open("ephemeris_mars_2028-35.txt", "r") as file:
    buffer = []  # 一時的に行を保持するリスト
    for line in file:
        # 行をバッファに追加
        buffer.append(line.strip())
...
# print("pykep lambert")
# print(l_pykep.get_v1()[0], l_pykep.get_v2()[0])
# print(l_pykep.get_v1()[1], l_pykep.get_v2()[1])
# print(l_pykep.get_v1()[2], l_pykep.get_v2()[2])
